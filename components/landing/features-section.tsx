...
const features = [
  ...
  {
    number: "06",
    title: "Entropy-Aware Data Preservation System",
    tagline: "Data Engineering",
    description: "A PostgreSQL system that scores state snapshots by entropy inside the database, then automatically decides whether each one should be discarded, compressed, preserved or archived.",
    builtFor: "Teams managing large volumes of state snapshots in Postgres",
    stack: ["PostgreSQL", "PL/pgSQL", "PHP", "Chart.js", "Docker"],
    url: "",
    visual: "deploy",
  },
  {
